...
void	fill_texture(char *line, t_data *texture)
{
	...
	if (ori_line[0] == 'N' && ori_line[1] == 'O' && ori_line[2] == ' ')
		texture->north = mlx_xpm_file_to_image(texture->mlx, line, &height, \
			&height);
	else if (ori_line[0] == 'S' && ori_line[1] == 'O' && ori_line[2] == ' ')
		texture->south = mlx_xpm_file_to_image(texture->mlx, line, &height, \
			&height);
	else if (ori_line[0] == 'W' && ori_line[1] == 'E' && ori_line[2] == ' ')
		texture->west = mlx_xpm_file_to_image(texture->mlx, line, &height, \
			&height);
	else if (ori_line[0] == 'E' && ori_line[1] == 'A' && ori_line[2] == ' ')
		texture->east = mlx_xpm_file_to_image(texture->mlx, line, &height, \
			&height);
}
